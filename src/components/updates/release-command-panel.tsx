      ...
      <CardHeader>
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">Fluxo pronto para PowerShell, com leitura rápida do passo certo antes de subir para o GitHub.</p>
          </div>
        ...
        {items.map((item) => (
          <div className="premium-tile rounded-2xl p-4" key={item.id}>
            ...
            <div className="mt-3 flex items-start gap-3 rounded-2xl bg-slate-950 px-4 py-3 font-mono text-[13px] text-slate-100">
              <Terminal className="mt-0.5 h-4 w-4 shrink-0 text-[rgba(201,168,111,0.9)]" />
